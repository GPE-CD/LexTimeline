...
def build_periods_from_tramitacoes(
    ...
    # O último evento pode ocorrer no mesmo órgão do evento anterior. Nessa hipótese,
    # ele não cria novo segmento, mas deve estender a data final da permanência.
    last_event_date = events[-1][0]
    end_date = TODAY if include_until_today else last_event_date
